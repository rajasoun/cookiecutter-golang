...
// NewLogger returns a logrus instance
...
func newLogrusLogger() *logrus.Logger {
	l := logrus.New()
	l.Out = os.Stderr
	l.Level = logrus.DebugLevel // Set the default log level. Adjust as needed.
	return l
}
...
// With allow us to define fields in our structured logs
func (f Fields) With(k string, v interface{}) Fields {
	f[k] = v
	return f
}

// WithFields allow us to define fields in our structured logs
